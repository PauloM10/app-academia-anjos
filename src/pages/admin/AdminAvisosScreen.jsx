          ...
          avisosFiltrados.map((aviso) => (
            <Card
              ...
              className={`cursor-pointer transition ${
                avisoSelecionado?.id === aviso.id ? "ring-2 ring-yellow-400" : ""
              }`}
            ...
            >
              <CardContent className="p-4">
                <div className="flex items-start justify-between gap-3">
                  ...
                  {aviso.destaque ? (
                    <Badge className="bg-yellow-100 text-blue-900" variant="secondary">
                      destaque
                    </Badge>
                  ) : null}
                </div>
            ...
            <Card className="border-2 border-yellow-300">
              <CardContent className="p-5 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Button className="bg-blue-900 hover:bg-blue-800 text-white" onClick={handleSalvarEdicao}>
                    Salvar edição
                  </Button>
